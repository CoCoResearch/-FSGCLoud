...
public class MultiCloud {
	...
	public static void main(String[] args) {
		...
		//--------------------------------------------
		Constraint requirescl_authentication_cl_gcp_authentication_iam = IntConstraintFactory.arithm(cl_authentication, "<=", cl_gcp_authentication_iam);
		requirescl_authentication_cl_gcp_authentication_iam.setName(Utilities.REQUIRES_CMC);
		solver.post(requirescl_authentication_cl_gcp_authentication_iam);
		Constraint requirescl_compute_cl_aws_compute = IntConstraintFactory.arithm(cl_compute, "<=", cl_aws_compute);
		requirescl_compute_cl_aws_compute.setName(Utilities.REQUIRES_CMC);
		solver.post(requirescl_compute_cl_aws_compute);
		Constraint requirescl_compute_cl_gcp_compute_computeengine = IntConstraintFactory.arithm(cl_compute, "<=", cl_gcp_compute_computeengine);
		requirescl_compute_cl_gcp_compute_computeengine.setName(Utilities.REQUIRES_CMC);
		solver.post(requirescl_compute_cl_gcp_compute_computeengine);
		Constraint requirescl_aws_cl_aws_authentication = IntConstraintFactory.arithm(cl_authentication, "<=", cl_aws_authentication);
		requirescl_aws_cl_aws_authentication.setName(Utilities.REQUIRES_CMC);
		solver.post(requirescl_aws_cl_aws_authentication);
		Constraint requirescl_gcp_cl_gcp_authentication = IntConstraintFactory.arithm(cl_authentication, "<=", cl_gcp_authentication);
		requirescl_gcp_cl_gcp_authentication.setName(Utilities.REQUIRES_CMC);
		solver.post(requirescl_gcp_cl_gcp_authentication);

		IntVar sum_cmc0 = VariableFactory.enumerated("sum_cmc0", 0, 3, solver); 
		BoolVar[] varsOr_cmc0 = new BoolVar[2];
		varsOr_cmc0[0] = cl_aws_storage;
		varsOr_cmc0[1] = cl_gcp_storage;
		...
		LogicalConstraintFactory.ifThenElse(cl_storage, or1_cmc0, or0_cmc0);

		IntVar sum_cmc1 = VariableFactory.enumerated("sum_cmc1", 0, 3, solver); 
		BoolVar[] varsOr_cmc1 = new BoolVar[2];
		varsOr_cmc1[0] = cl_aws_messaging;
		varsOr_cmc1[1] = cl_gcp_bigdata_pubsub;
		...
		LogicalConstraintFactory.ifThenElse(cl_messaging, or1_cmc1, or0_cmc1);
		
		IntVar sum_cmc2 = VariableFactory.enumerated("sum_cmc2", 0, 3, solver); 
		BoolVar[] varsOr_cmc2 = new BoolVar[2];
		varsOr_cmc2[0] = cl_aws_messaging;
		varsOr_cmc2[1] = cl_gcp_bigdata_pubsub;
		...
		LogicalConstraintFactory.ifThenElse(cl_network, or1_cmc2, or0_cmc2);
	...
	private static void initializeVars(){
		...
		cl_authentication = VariableFactory.bool("feature_cl_authentication", solver);
		...
		cl_compute = VariableFactory.bool("feature_cl_compute", solver);
		...
		cl_storage_object = VariableFactory.bool("feature_cl_storage_object", solver);
		...
		cl_signature = VariableFactory.bool("feature_cl_signature", solver);
